                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                         ...
                         <div class="col-md-offset-2 col-md-10">
                            ...
                            <h4>Central de Representaciones Canarias S.L.</h4>
                            <asp:Image ID="Image1" runat="server" Height="141px" ImageUrl="~/Image/centralrecto1.jpg" Width="312px" />
                        </div>
                    </div>

                    <div class="form-group">

                        <asp:Label runat="server" AssociatedControlID="UserName" CssClass="col-md-2 control-label">Cliente</asp:Label>
                        <div class="col-md-10">
