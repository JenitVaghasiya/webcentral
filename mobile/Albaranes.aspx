<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Albaranes.aspx.cs" Inherits="mobile_Albaranes" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel runat="server" EnableViewState="true" ID="UpdatePanel" ClientIDMode="AutoID" ChildrenAsTriggers="true" RenderMode="Inline" UpdateMode="Always">
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="GridViewAlbaransver" />
            </Triggers>
            <ContentTemplate>
                ...
                <script type="text/javascript">
                    ...
                    function AdjustSize() {
                        ...
                        GridViewGroup.SetHeight(height);
                        height = Math.max(0, document.documentElement.clientHeight * 0.75);

                        gridViewArtículo.SetHeight(height);
                    ...
                    function SelectArticle(index) {
                        ...
                        var hash = location.hash;
                        url = url.replace(hash, '');
                        var divName = "#gridselectedarticulo";
                        divShow(divName);
                        window.location.href = url + divName;
                    }
                    ...
                    <div id="gridgrupo" class="row" runat="server">
                        ...
                        <div class="col-md-12 searchtab">
                            <dx:ASPxGridView ClientInstanceName="GridViewAlbaransver" Width="100%" ID="GridViewAlbaransver" runat="server" KeyFieldName="SerieAlbaran"
                                ...
                                <SettingsLoadingPanel Mode="ShowAsPopup" />
                                <Columns>
                                    <dx:GridViewDataTextColumn Name="foto" FieldName="foto" Caption="#" Width="20px">
                                        <EditFormSettings Visible="False" />
                                        <DataItemTemplate>
                                            <dx:ASPxHyperLink ID="linkfoto" runat="server" Text="S" OnInit="linkselect_Init" CssClass="select">
                                                <ClientSideEvents Click="function(s, e) {clb.PerformCallback('SaveData');}" />
                                            </dx:ASPxHyperLink>

                                        </DataItemTemplate>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="SerieAlbaran" Caption="Albaran" >
                                        <Settings AllowAutoFilter="False"></Settings>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Fecha" Caption="Fecha" PropertiesTextEdit-DisplayFormatString="dd-MMM-yyy">
                                        <Settings AllowAutoFilter="False"></Settings>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="SerieFactura" Caption="Factura" >
                                        <Settings AllowAutoFilter="False"></Settings>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="DesObra" Caption="Obra" >
                                        <Settings AllowAutoFilter="False"></Settings>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Importe" Caption="Importe"  UnboundType="Decimal" PropertiesTextEdit-DisplayFormatString="{0:n}">
                                        <Settings AllowAutoFilter="False"></Settings>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="ImporteIgic" Caption="Importe+Igic"  UnboundType="Decimal" PropertiesTextEdit-DisplayFormatString="{0:n}">
                                        <Settings AllowAutoFilter="False"></Settings>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Vendedor" Caption="Vendedor" >
                                        <Settings AllowAutoFilter="False"></Settings>
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                ...
                <div>
                    ...
                    <div runat="server" id="myModal" class="modal fade" role="dialog">
