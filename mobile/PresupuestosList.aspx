<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PresupuestosList.aspx.cs" Inherits="mobile_PresupuestosList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel runat="server" EnableViewState="true" ID="UpdatePanel" ClientIDMode="AutoID" ChildrenAsTriggers="true" RenderMode="Inline" UpdateMode="Always">
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="GridViewPresupuestosver" />
            </Triggers>
            <ContentTemplate>
                ...
                <script type="text/javascript">
                    ...
                    function SearchByAlbaran(e) {
                        ...
                        if (e != undefined) {
                            if (e.keyCode == 13) {
                                ...
                                GridViewPresupuestosver.PerformCallback("searchalbaran");
                            }
                        }
                        else {
                            GridViewPresupuestosver.PerformCallback("searchalbaran");
                    ...
                    function SearchByFectura(e) {
                        if (e != undefined) {
                            if (e.keyCode == 13) {
                                GridViewPresupuestosver.PerformCallback("searchfectura");
                            }
                        }
                        else {
                            GridViewPresupuestosver.PerformCallback("searchfectura");
                        ...
                        <div class="row searchtab" style="padding-bottom: 15px;">
                            ...
                            <dx:ASPxDateEdit ID="dttoDate" runat="server" OnInit="dttoDate_Init" ClearButton-DisplayMode="Always">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12" style="padding-top: 20px;">
                                    <dx:BootstrapButton ID="BootstrapButton2" runat="server" EnableTheming="False" Text="Todos los presupuestos des ano"
                            ...
                            <dx:ASPxGridView ClientInstanceName="GridViewPresupuestosver" Width="100%" ID="GridViewPresupuestosver" runat="server" KeyFieldName="SeriePresupuesto"
                                ...
                                <Columns>
                                    <dx:GridViewCommandColumn VisibleIndex="0" Width="20px">
                                        <CustomButtons>
                                            <dx:GridViewCommandColumnCustomButton ID="btnRecover" Text="R" Visibility="AllDataRows">
                                            </dx:GridViewCommandColumnCustomButton>
                                        </CustomButtons>
                                    </dx:GridViewCommandColumn>
                                    <dx:GridViewDataTextColumn FieldName="SeriePresupuesto" Caption="Presupuesto">
                                        <Settings AllowAutoFilter="False"></Settings>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Desstatus" Caption="Status">
                                        <Settings AllowAutoFilter="False"></Settings>
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Albarán" Caption="Albarán">
                                        <Settings AllowAutoFilter="False"></Settings>
                                    </dx:GridViewDataTextColumn>
                                </Columns>
