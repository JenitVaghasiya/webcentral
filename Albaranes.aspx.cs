...
public partial class Albaranes : BasePage
{
 ...
 //       }
    ...
    protected void linkPhoto_Init(object sender, EventArgs e)
    {
        try
        {
            ...
            GridViewDataItemTemplateContainer c = ((ASPxHyperLink)sender).NamingContainer as GridViewDataItemTemplateContainer;
            int rowIndex = c.VisibleIndex;
            //GridViewAlbaransverDetail.Selection.SelectRow(rowIndex);
            //GridViewAlbaransverDetail.FocusedRowIndex = rowIndex;
            var editorAuto = 0;
            int.TryParse(Convert.ToString(GridViewAlbaransverDetail.GetRowValues(rowIndex, "editorFoto")), out editorAuto);
